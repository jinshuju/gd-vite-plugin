...
function getImportName(node) {
  ...
  const firstDefaultSpec = specifiers.find((specifier) =>
...
function getVariableName(node) {
  ...
  const firstVariable = declarations.find((declaration) =>
...
export default function vitePluginIgnore(
  params: vitePluginIgnoreType = {}
): PluginOption {
